...
.method public synthetic constructor <init>(Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;ZLandroid/util/Pair;Landroid/graphics/drawable/Icon;)V
    ...
    iput-object p3, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl-$$ExternalSyntheticLambda9;->f$2:Lcom/android/settingslib/drawer/Tile;

    iput-boolean p4, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl-$$ExternalSyntheticLambda9;->f$3:Z

    iput-object p5, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl-$$ExternalSyntheticLambda9;->f$4:Landroid/util/Pair;

    iput-object p6, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl-$$ExternalSyntheticLambda9;->f$5:Landroid/graphics/drawable/Icon;
...
.method public final run()V
    ...
    iget-object v2, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl-$$ExternalSyntheticLambda9;->f$2:Lcom/android/settingslib/drawer/Tile;

    iget-boolean v3, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl-$$ExternalSyntheticLambda9;->f$3:Z

    iget-object v4, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl-$$ExternalSyntheticLambda9;->f$4:Landroid/util/Pair;

    iget-object v5, p0, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl-$$ExternalSyntheticLambda9;->f$5:Landroid/graphics/drawable/Icon;

    invoke-static/range {v0 .. v5}, Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;->$r8$lambda$wRiPo21Zs6DLY1OdivhiwC5zS60(Lcom/android/settings/dashboard/DashboardFeatureProviderImpl;Landroidx/preference/Preference;Lcom/android/settingslib/drawer/Tile;ZLandroid/util/Pair;Landroid/graphics/drawable/Icon;)V
