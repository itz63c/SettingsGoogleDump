...
.method getCardsToKeep(Ljava/util/List;)Ljava/util/List;
    ...
    new-instance v0, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$i2XxelFfreFvy4VUCrrokgW-rlQ;

    invoke-direct {v0, p0}, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$i2XxelFfreFvy4VUCrrokgW-rlQ;-><init>(Lcom/android/settings/homepage/contextualcards/ContextualCardManager;)V
    ...
    new-instance v0, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$Onj40QWj8H-wVTuw0gml_zRHerA;

    invoke-direct {v0, p0}, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$Onj40QWj8H-wVTuw0gml_zRHerA;-><init>(Lcom/android/settings/homepage/contextualcards/ContextualCardManager;)V
...
.method public onContextualCardUpdated(Ljava/util/Map;)V
    ...
    new-instance v2, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$dN4wLTAVuRa0ccaT-rdpw8XokPg;

    invoke-direct {v2, v0}, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$dN4wLTAVuRa0ccaT-rdpw8XokPg;-><init>(Ljava/util/Set;)V
    ...
    new-instance v2, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$DhC-FnvJHp8hbrOhpVfGrEnzAJI;

    invoke-direct {v2, v0}, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$DhC-FnvJHp8hbrOhpVfGrEnzAJI;-><init>(Ljava/util/Set;)V
    ...
    sget-object v0, Lcom/android/settings/homepage/contextualcards/-$$Lambda$2uajARPg7zs3QXdN3ekutEAqAgM;->INSTANCE:Lcom/android/settings/homepage/contextualcards/-$$Lambda$2uajARPg7zs3QXdN3ekutEAqAgM;
...
.method public onFinishCardLoading(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/settings/homepage/contextualcards/-$$Lambda$POzabXFUlbK-Ali1o52GQYJk4r4;->INSTANCE:Lcom/android/settings/homepage/contextualcards/-$$Lambda$POzabXFUlbK-Ali1o52GQYJk4r4;
    ...
    sget-object v1, Lcom/android/settings/homepage/contextualcards/-$$Lambda$POzabXFUlbK-Ali1o52GQYJk4r4;->INSTANCE:Lcom/android/settings/homepage/contextualcards/-$$Lambda$POzabXFUlbK-Ali1o52GQYJk4r4;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    sget-object v0, Lcom/android/settings/homepage/contextualcards/-$$Lambda$2jjglxaOEFD6cHKfgqKOOA4s3xw;->INSTANCE:Lcom/android/settings/homepage/contextualcards/-$$Lambda$2jjglxaOEFD6cHKfgqKOOA4s3xw;
    ...
    sget-object v0, Lcom/android/settings/homepage/contextualcards/-$$Lambda$E2McIAGPWBO62AkYPcfatUmDGDA;->INSTANCE:Lcom/android/settings/homepage/contextualcards/-$$Lambda$E2McIAGPWBO62AkYPcfatUmDGDA;
...
.method sortCards(Ljava/util/List;)Ljava/util/List;
    ...
    sget-object p1, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$qDAfV4NARwRTTUE1XhLrp3ffWIg;->INSTANCE:Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$qDAfV4NARwRTTUE1XhLrp3ffWIg;
    ...
    sget-object v0, Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$HCYXY0avd9-ABeZFebPSWn57mcc;->INSTANCE:Lcom/android/settings/homepage/contextualcards/-$$Lambda$ContextualCardManager$HCYXY0avd9-ABeZFebPSWn57mcc;
