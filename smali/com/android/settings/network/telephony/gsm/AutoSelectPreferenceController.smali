...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p1}, Lcom/android/settings/network/PreferredNetworkModeContentObserver;-><init>(Landroid/os/Handler;)V

    iput-object p2, p0, Lcom/android/settings/network/telephony/gsm/AutoSelectPreferenceController;->mPreferredNetworkModeObserver:Lcom/android/settings/network/PreferredNetworkModeContentObserver;

    .line 82
    new-instance p1, Lcom/android/settings/network/telephony/gsm/-$$Lambda$AutoSelectPreferenceController$nv3qEflRFs4CmAoimq3Nmp00INw;

    invoke-direct {p1, p0}, Lcom/android/settings/network/telephony/gsm/-$$Lambda$AutoSelectPreferenceController$nv3qEflRFs4CmAoimq3Nmp00INw;-><init>(Lcom/android/settings/network/telephony/gsm/AutoSelectPreferenceController;)V

    invoke-virtual {p2, p1}, Lcom/android/settings/network/PreferredNetworkModeContentObserver;->setPreferredNetworkModeChangedListener(Lcom/android/settings/network/PreferredNetworkModeContentObserver$OnPreferredNetworkModeChangedListener;)V
...
.method private synthetic lambda$setAutomaticSelectionMode$2(J)V
    ...
    new-instance p2, Lcom/android/settings/network/telephony/gsm/-$$Lambda$AutoSelectPreferenceController$ErvGTO5Vv19FZdfnrbkXgw6Q33Q;

    invoke-direct {p2, p0, v0}, Lcom/android/settings/network/telephony/gsm/-$$Lambda$AutoSelectPreferenceController$ErvGTO5Vv19FZdfnrbkXgw6Q33Q;-><init>(Lcom/android/settings/network/telephony/gsm/AutoSelectPreferenceController;I)V
...
.method public synthetic lambda$setAutomaticSelectionMode$1$AutoSelectPreferenceController(I)V
    .locals 0
...
.method public synthetic lambda$setAutomaticSelectionMode$2$AutoSelectPreferenceController(J)V
    .locals 0
...
.method setAutomaticSelectionMode()Ljava/util/concurrent/Future;
    ...
    .line 171
    new-instance v2, Lcom/android/settings/network/telephony/gsm/-$$Lambda$AutoSelectPreferenceController$2Ji7qUm2JgL2YDyAta-zwj_6qc0;

    invoke-direct {v2, p0, v0, v1}, Lcom/android/settings/network/telephony/gsm/-$$Lambda$AutoSelectPreferenceController$2Ji7qUm2JgL2YDyAta-zwj_6qc0;-><init>(Lcom/android/settings/network/telephony/gsm/AutoSelectPreferenceController;J)V
