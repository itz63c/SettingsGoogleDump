...
.method public static synthetic $r8$lambda$GWwvNYXUyGi9EDYoVguZZykrudE(Ljava/util/Map;Ljava/util/Map$Entry;)V
    .locals 0
...
.method public static synthetic $r8$lambda$S1vK9CpeSFxK6IiDwwt4wPCCs-A(Ljava/util/Map;Ljava/util/Map$Entry;)Z
    .locals 0

    invoke-static {p0, p1}, Lcom/android/wifitrackerlib/SavedNetworkTracker;->lambda$updateStandardWifiEntryConfigs$2(Ljava/util/Map;Ljava/util/Map$Entry;)Z
...
.method private static synthetic lambda$updatePasspointWifiEntryConfigs$3(Landroid/net/wifi/hotspot2/PasspointConfiguration;)Ljava/lang/String;
    .locals 0
...
.method private static synthetic lambda$updatePasspointWifiEntryConfigs$4(Ljava/util/Map;Ljava/util/Map$Entry;)Z
    .locals 1
...
.method private static synthetic lambda$updateStandardWifiEntryConfigs$1(Landroid/net/wifi/WifiConfiguration;)Z
    .locals 0
...
.method private static synthetic lambda$updateStandardWifiEntryConfigs$2(Ljava/util/Map;Ljava/util/Map$Entry;)Z
    .locals 1
...
.method private static synthetic lambda$updateStandardWifiEntryScans$0(Ljava/util/Map;Ljava/util/Map$Entry;)V
    .locals 1
...
.method private updatePasspointWifiEntryConfigs(Ljava/util/List;)V
    ...
    invoke-direct {v1, p1}, Lcom/android/wifitrackerlib/SavedNetworkTracker-$$ExternalSyntheticLambda5;-><init>(Ljava/util/Map;)V
...
.method private updateStandardWifiEntryConfigs(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/wifitrackerlib/SavedNetworkTracker-$$ExternalSyntheticLambda7;->INSTANCE:Lcom/android/wifitrackerlib/SavedNetworkTracker-$$ExternalSyntheticLambda7;
